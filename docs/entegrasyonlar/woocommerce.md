...
WordPress tabanlı WooCommerce mağazanıza Verimor SMS entegrasyonu kurarak sipariş bildirimlerini otomatikleştirin.

## Kurulum Gereksinimleri

- Aktif Verimor hesabı ve API erişimi
- Onaylı SMS başlığı
- WooCommerce hesabı ve yönetici erişimi

## Genel Kurulum Adımları

1. Verimor OİM > **SMS Ayarları** > **API** bölümünden kimlik bilgilerinizi alın
2. WooCommerce yönetim panelinde entegrasyon / webhook ayarlarına gidin
